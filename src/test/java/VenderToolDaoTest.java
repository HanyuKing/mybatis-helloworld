...
/**
 * @author wanghanyu
 * @create 2017-08-02 22:01
 */
public class VenderToolDaoTest {
    @Test
    public void testGetStudent() throws Exception {
        ...
        String statement = "VenderToolMapper.list";
        // 4.2) paramter: 传进去的参数，也就是需要获取students表中主键值为1的记录
        int parameter = 1;
        // 5. SqlSession 实例来直接执行已映射的 SQL 语句，selectOne表示获取的是一条记录
        List<VenderTool> venderTool = session.selectList(statement, parameter);

        System.out.println(venderTool.size());
